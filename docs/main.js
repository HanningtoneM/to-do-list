...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_taskAdd_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/taskAdd.js */ \"./src/modules/taskAdd.js\");\n/* harmony import */ var _modules_clearCompleteTask_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/clearCompleteTask.js */ \"./src/modules/clearCompleteTask.js\");\n\n\n\n\nlet tasks = [];\n\nconst getLocalData = () => {\n  if (localStorage.getItem('localData')) {\n    tasks = JSON.parse(localStorage.localData);\n  }\n};\n\ngetLocalData();\n(0,_modules_taskAdd_js__WEBPACK_IMPORTED_MODULE_1__.listCreate)(tasks);\n(0,_modules_taskAdd_js__WEBPACK_IMPORTED_MODULE_1__.addTask)(tasks);\n(0,_modules_clearCompleteTask_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(tasks);\n\n//# sourceURL=webpack://setup-webpack/./src/index.js?");

/***/ }),

/***/ "./src/modules/TaskComplete.js":
/*!*************************************!*\
  !*** ./src/modules/TaskComplete.js ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nconst checkBox = (index, items) => {\n  items[index].completed = !items[index].completed;\n  localStorage.localData = JSON.stringify(items);\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((items) => {\n  const checkboxes = document.querySelectorAll('.checkbox');\n  checkboxes.forEach((checkbox, index) => {\n    checkbox.addEventListener('change', () => {\n      checkBox(index, items);\n    });\n  });\n});\n\n//# sourceURL=webpack://setup-webpack/./src/modules/TaskComplete.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _taskAdd_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./taskAdd.js */ \"./src/modules/taskAdd.js\");\n/* eslint-disable no-restricted-globals */\n\n\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((items) => {\n  const checkedTasks = [];\n  const deleteButton = document.querySelector('.delete');\n  deleteButton.addEventListener('click', () => {\n    for (let i = 0; i < items.length; i += 1) {\n      if (items[i].completed === true) {\n        checkedTasks.push(items[i]);\n      }\n    }\n    items = items.filter((x) => !checkedTasks.includes(x));\n    let i = 1;\n    items.forEach((task) => {\n      task.index = i;\n      i += 1;\n    });\n    localStorage.localData = JSON.stringify(items);\n    (0,_taskAdd_js__WEBPACK_IMPORTED_MODULE_0__.listCreate)(items);\n    location.reload();\n  });\n});\n\n//# sourceURL=webpack://setup-webpack/./src/modules/clearCompleteTask.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"addTask\": () => (/* binding */ addTask),\n/* harmony export */   \"listCreate\": () => (/* binding */ listCreate)\n/* harmony export */ });\n/* harmony import */ var _taskRemove_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./taskRemove.js */ \"./src/modules/taskRemove.js\");\n/* harmony import */ var _TaskComplete_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./TaskComplete.js */ \"./src/modules/TaskComplete.js\");\n/* harmony import */ var _taskEdit_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./taskEdit.js */ \"./src/modules/taskEdit.js\");\n// eslint-disable-next-line import/no-cycle\n\n\n\n\nconst compare = (a, b) => {\n  if (a.index < b.index) {\n    return -1;\n  }\n  if (a.index > b.index) {\n    return 1;\n  }\n  return 0;\n};\n\nconst listCreate = (items) => {\n  items.sort(compare);\n  let editedTasks = '';\n  items.forEach((item) => {\n    let checked = '';\n    if (item.completed) {\n      checked = ' checked';\n    }\n    editedTasks += `<div class=\"item${checked}\"><input class=\"checkbox\" value=\"${item.index}\" type=\"checkbox\"${checked}><input class=\"taskText\" type=\"text\" value=\"${item.description}\"><i class=\"far fa-trash-alt fa-lg\"></i></div>`;\n  });\n  const list = document.getElementById('todolist');\n  list.innerHTML = editedTasks;\n  (0,_TaskComplete_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(items);\n  (0,_taskEdit_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(items);\n  (0,_taskRemove_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(items);\n};\n\nconst addTask = (items) => {\n  const input = document.querySelector('.add');\n  input.addEventListener('keypress', (e) => {\n    if (e.keyCode === 13) {\n      const newTask = {\n        description: input.value,\n        completed: false,\n        index: items.length + 1,\n      };\n      items.push(newTask);\n      listCreate(items);\n      input.value = '';\n      localStorage.localData = JSON.stringify(items);\n    }\n  });\n};\n\n\n\n//# sourceURL=webpack://setup-webpack/./src/modules/taskAdd.js?");
